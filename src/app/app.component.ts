 ...
 import { startWith, catchError, filter, first } from 'rxjs/operators';
...
const subscribe3 =source3.pipe(first())
.subscribe(data => console.log(`Affichage de la liste des elements : ${data}`));
